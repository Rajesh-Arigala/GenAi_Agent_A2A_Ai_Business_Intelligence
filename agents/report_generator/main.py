...
agent_card = AgentCard(
    ...
    skills=[
        AgentSkill(
            ...
            description="Synthesizes competitive intelligence into an executive brief",
            tags=["report", "competitive intelligence"],
            examples=["Generate competitive report for Anthropic"],
        )
    ],
)
