...
agent_card = AgentCard(
    ...
    url=SERVICE_URL,
    description="Analyzes public sentiment and brand perception of a competitor",
    version="1.0",
    ...
    skills=[
        AgentSkill(
            ...
            description="Analyzes public sentiment for a competitor",
            tags=["sentiment", "brand", "competitive intelligence"],
            examples=["Analyze sentiment for Anthropic"],
        )
    ],
)
